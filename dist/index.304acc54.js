...
})({"j3Lez":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "556ee1a4304acc54";
"use strict";
...
function organize(composite) {
    ...
    if (removedInputOffset) for(let i = 0; i < grid[0].length; i++){
...
},{"./example":"dPYp5","@parcel/transformer-js/src/esmodule-helpers.js":"2lomK"}],"dPYp5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
